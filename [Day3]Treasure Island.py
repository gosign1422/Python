...
if choice1=="left":
    ...
    if choice2=="wait":
        ...
        if choice3=="red":
            ...
            print("Fortune favours the bold. You Win!")
        elif choice3 == "blue":
            print("You entered a room with negative temperatures. Game Over!")
        else:
            print("Incorrect Choice")
    elif choice2=="swim":
        print("Too impatient! You were attacked by a shark. Game Over!")
    else:
        print("Incorrect Choice")
elif choice1=="right":
